      ...
      <div className="max-w-[1700px] mx-auto px-6 py-2.5 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2.5 flex-shrink-0">
          ...
          <div className="flex items-center pl-2 border-l border-[#E8E7E3] flex-shrink-0">
            <div className="relative flex items-center bg-[#F8F8F6] border border-[#E8E7E3] rounded-lg px-2.5 h-9">
              <div className="w-5 h-5 rounded-md bg-[#121316] text-white flex items-center justify-center text-[10px] font-bold mr-2 flex-shrink-0">
                {currentDisplay.name.charAt(0)}
              </div>
              <div className="text-left mr-3 flex-shrink-0">
                <div className="text-xs font-semibold text-[#121316] leading-none truncate max-w-[140px]">
                  {currentDisplay.name}
                </div>
                <div className="text-[9px] text-[#8B8E99] font-medium leading-none mt-0.5">
                  {currentDisplay.role}
                </div>
              </div>
              <select
              ...
              <ChevronDown className="w-3 h-3 text-[#8B8E99] pointer-events-none" />
            </div>
          </div>
        </div>
      </div>
