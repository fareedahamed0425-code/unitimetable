...
export const ROLE_CONFIGS: Record<RoleType, RoleConfig> = {
  SUPER_ADMIN: {
    ...
    description: 'Complete system-wide administrative control, multi-department oversight, infrastructure locks, and security governance.',
    departmentScope: 'All Campuses & Faculties (Global Scope)',
  ...
  UNIVERSITY_ADMIN: {
    ...
    departmentScope: 'Metropolitan Institute of Science & Technology',
    defaultSection: 'role-profile',
    navGroups: [
      {
  ...
  DEPARTMENT_ADMIN: {
    ...
    departmentScope: 'Dept. of Computer Science & Engineering',
    defaultSection: 'role-profile',
    navGroups: [
      {
  ...
  TIMETABLE_COORDINATOR: {
    ...
    departmentScope: 'Central Timetabling Directorate',
  ...
  STUDENT: {
    ...
    departmentScope: 'B.Tech CSE • Semester 3 • Section A',
    defaultSection: 'role-profile',
    navGroups: [
      {
